function f  = replace_chromosome(intermediate_chromosome, nObj, nVar,pop)
...
[temp,index] = sort(intermediate_chromosome(:, nVar+ nObj + 1));
clear temp m
...
max_rank = max(intermediate_chromosome(:,nVar+ nObj + 1));
...
for i = 1 : max_rank
    ...
    current_index = max(find(sorted_chromosome(:,nVar+ nObj + 1) == i));
    ...
    if current_index > pop
        ...
        [temp_sort,temp_sort_index] = ...
            sort(temp_pop(:, nVar+ nObj + 2),'descend');
